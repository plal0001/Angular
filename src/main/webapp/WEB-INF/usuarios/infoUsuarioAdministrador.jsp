...
<html data-ng-app="clientesApp">
    ...
    <head>
        ...
        <script  src="/ButanClub/js/Angular.js"></script>
        <script  src="/ButanClub/js/app.js"></script>
        <script  src="/ButanClub/js/components.js"></script>        
        <script  src="/ButanClub/js/services.js"></script>
        <script  src="/ButanClub/js/controllers.js"></script> 
    </head>
    ...
    <%@include file="/WEB-INF/templates/modulos/gestion-usuarios_JS.jspf" %>
